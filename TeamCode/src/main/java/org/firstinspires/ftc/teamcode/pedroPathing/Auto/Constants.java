...
public class Constants {
    ...
    public final Pose POSE_ONE = new Pose(0,0,Math.toRadians(0));
    public final Pose POSE_TWO = new Pose(0,24,Math.toRadians(90));
    public final Pose POSE_THREE = new Pose(0,0,Math.toRadians(180));
    public final Pose POSE_FOUR = new Pose(0,0,Math.toRadians(270));
